...
class SearchFor {
    func regexSearch(pattern:String, searchIn:String) -> [String] {
        ...
        do {
            ...
            let regex = try NSRegularExpression(pattern: pattern, options: [NSRegularExpression.Options.caseInsensitive, NSRegularExpression.Options.useUnicodeWordBoundaries])
